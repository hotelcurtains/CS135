...
;;
;; Our goal here is to build up from ground up a framework of functions which
...
;; For simplicity, assume below that k is a positive integer >= 2,
;; and that the list lst contains only distinct numbers.
;; The "subsets" function should return the list of all possible k-element subsets
